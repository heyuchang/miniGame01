...
export class GamePanel extends UIViewControl {
    ...
    refreshClick(){
        ...
        CarColorsEntryCreat.instance.uiSysterm.showUI(UINames.RefreshPage)
    }
    sortClick(){
        if (!CarColorsEntryCreat.instance.roleSysterm.isGaming) return
        CarColorsEntryCreat.instance.roleSysterm.isGaming = false
        CarColorsEntryCreat.instance.uiSysterm.showUI(UINames.SortPage)
    }
    vipClick(){
        if (!CarColorsEntryCreat.instance.roleSysterm.isGaming) return
        ...
        CarColorsEntryCreat.instance.roleSysterm.isGaming = false
        CarColorsEntryCreat.instance.uiSysterm.showUI(UINames.VipPage)
    }
